...
import com.ohayoyo.gateway.mongo.config.MongoGatewayConfig;
import com.ohayoyo.gateway.mongo.container.MongoGatewayContainer;
...
@Configuration
@Import({
        MongoGatewayConfig.class
})
public class ConfigMongoGatewayChannel {

    @Bean(name = "gatewayContainer")
    public GatewayContainer gatewayContainer() {
        return new MongoGatewayContainer();
    }
